...
class _SearchPageState extends State<SearchPage> {
  ...
  void performSearch(String query) async {
    ...
    Future<Map<String, dynamic>> typesenseSearch(String collection, Map<String, String> searchParams) async {
      final searchResults = await typesenseClient.collection(collection).documents.search(searchParams);
    ...
    try {
      ...
      for (String collection in ['Users', 'Communities', 'Discussions']) {
        final result = await typesenseSearch(collection, searchParameters[collection] as Map<String, String>);
              ...
              child: _isSearching
                  ...
                  : _searchResults.values.every((list) => list.isEmpty)
                      ...
                      : ListView(
                          children: [
                            SearchResultBox(
                              title: 'Users', results: _searchResults['Users'], // Assume this is filtered for users
                            ),
                            SearchResultBox(
                              title: 'Communities',
                              results: _searchResults['Communities'], // Assume this is filtered for communities
                            ),
                            SearchResultBox(
                              title: 'Discussions',
                              results: _searchResults['Discussions'], // Assume this is filtered for discussions
                            ),
                          ],
                        ),
            ),
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  ...
                  leading: CircleAvatar(
                    backgroundImage: NetworkImage(entities_to_img[title] as String),
